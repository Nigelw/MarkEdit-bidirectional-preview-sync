...
export const EXTENSION_NAME = 'Bidirectional Scroll Sync';
 ...
 */
export const GITHUB_REPO = 'Nigelw/MarkEdit-bidirectional-scroll-sync';
 ...
 */
export const UPDATE_ASSET_NAME = 'markedit-bidirectional-scroll-sync.js';

/** localStorage key holding the epoch-ms timestamp of the last update check. */
export const LAST_CHECK_STORAGE_KEY = 'markedit-bidirectional-scroll-sync.updater.last-check';

/** localStorage key holding a JSON array of release tags the user chose to skip. */
export const SKIPPED_VERSIONS_STORAGE_KEY = 'markedit-bidirectional-scroll-sync.updater.skipped';
